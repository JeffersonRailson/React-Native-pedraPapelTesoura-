...
// tentativa para corrigir o problema com os pontos
/*
...
*/
  render() {
    return (
      ...
      <Text style={styles.textPontos}>{this.state.pontosPlayer}</Text>
      ...
      <Text style={styles.textPontos}>Pontos</Text>
      <Text style={styles.textPontos}>{this.state.pontosCpu}</Text>
